...
ARGOCD_VALUES="$PROJECT_ROOT/argocd/helm-values/argocd-values.yaml"
...
echo "   kubectl apply -k argocd/system-apps-kustomize/aws-load-balancer-controller/overlays/dev/"
echo ""
echo "5️⃣  ${YELLOW}Deploy Applications:${NC}"
echo "   kubectl apply -f argocd/applications/flowise-dev.yaml"
echo ""
echo -e "${BLUE}========================================${NC}"
echo ""
