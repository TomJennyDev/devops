...
echo "# Or use ArgoCD CLI: argocd app list"
echo ""
echo "# Sync an application"
echo "argocd app sync infrastructure-apps-dev"
echo "argocd app sync flowise-dev"
echo ""
echo "# Watch application status"
echo "argocd app get infrastructure-apps-dev"
echo ""
